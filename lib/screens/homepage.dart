...
import 'package:nearby_places/models/models/auto_complete_result.dart';
import 'package:nearby_places/providers/search_places.dart';
import 'package:nearby_places/services/map_services.dart';
...
//Initial map position on load
  ...
  void fetchImage() async {
    if (_pageController.page !=
        null) 
        if (allFavoritePlaces[_pageController.page!.toInt()]
            ['photos'] !=
        null) {
      setState(() {
